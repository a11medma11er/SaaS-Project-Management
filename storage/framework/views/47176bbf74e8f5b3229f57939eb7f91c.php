...
<?php $__env->startSection('title'); ?>
    <?php echo e(isset($task) ? 'Edit Task' : 'Create Task'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(isset($task) ? route('management.tasks.update', $task) : route('management.tasks.store')); ?>" 
          method="POST">
        <?php echo csrf_field(); ?>
        <?php if(isset($task)): ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       name="client_name" 
                                       value="<?php echo e(old('client_name', $task->client_name ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       name="due_date" 
                                       value="<?php echo e(old('due_date', isset($task) ? $task->due_date->format('Y-m-d') : '')); ?>" 
                                       required>
...
unset($__errorArgs, $__bag); ?>" name="status" required>
                                    <option value="New" <?php echo e(old('status', $task->status ?? '') == 'New' ? 'selected' : ''); ?>>New</option>
                                    <option value="Pending" <?php echo e(old('status', $task->status ?? '') == 'Pending' ? 'selected' : ''); ?>>Pending</option>
                                    <option value="Inprogress" <?php echo e(old('status', $task->status ?? '') == 'Inprogress' ? 'selected' : ''); ?>>In Progress</option>
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="checkbox" name="assigned_users[]" 
                               value="<?php echo e($user->id); ?>" id="user-<?php echo e($user->id); ?>"
                               <?php echo e(isset($task) && $task->assignedUsers->contains($user->id) ? 'checked' : ''); ?>>
                        <label class="form-check-label" for="user-<?php echo e($user->id); ?>">
                            <div class="d-flex align-items-center">
                                <?php if($user->avatar): ?>
                                <img src="<?php echo e(asset('storage/' . $user->avatar)); ?>" alt="<?php echo e($user->name); ?>" class="avatar-xs rounded-circle me-2">
                                <?php else: ?>
            ...
            <div class="text-end mb-3">
                <button type="submit" class="btn btn-success w-100">
                    <i class="ri-save-line align-bottom me-1"></i> <?php echo e(isset($task) ? 'Update Task' : 'Create Task'); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\work\my projects\Git\Project-Management\resources\views/management/tasks/create.blade.php ENDPATH**/ ?>