...
@section('content')
    ...
    {{-- Create Board Modal removed - board columns are fixed --}}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (typeof dragula !== 'undefined') {
                var drake = dragula(tasks_list)
                    ...
                    .on('drop', function (el, target, source, sibling) {
                        ...
                        fetch('{{ route("management.tasks.kanban.update-status") }}', {
                            method: 'POST',
                            headers: {
            ...
            function loadAvailableTasks(projectId = null, priority = null) {
                ...
                const url = '{{ route("management.tasks.kanban.available") }}' + '?' + params.toString();
            ...
            if (btnAddSelected) {
                btnAddSelected.addEventListener('click', function() {
                    ...
                    fetch('{{ route("management.tasks.kanban.add-existing") }}', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Accept': 'application/json',
            ...
            document.addEventListener('click', function(e) {
                if (e.target.closest('.remove-from-kanban')) {
                    ...
                    fetch('{{ route("management.tasks.kanban.remove") }}', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Accept': 'application/json',
